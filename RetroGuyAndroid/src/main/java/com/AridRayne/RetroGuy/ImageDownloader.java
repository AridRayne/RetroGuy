...
public class ImageDownloader {
	public static String downloadImages(String baseUrl, List<String> imageUrls, String comparisonUrl, final Activity activity, final Boolean finishActivity) {
		...
		for (String url : imageUrls) {
			final File file = new File(activity.getDir(url.substring(0, url.indexOf("/")), 0), url.substring(url.indexOf("/") + 1).replace("/", "-"));
